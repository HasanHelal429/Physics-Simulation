...
p1 = [Point(x1, y1, vx1, vy1, 100 * mass1, r1)]
for j in range(numP - 1):
    p1.append(Point(x1, y1 + 100, -vx1 + 10, vy1, mass1, r1))
...
while running:
    ...
    for i in range(numP):
        ...
        for k in range(numP):
            if(i != k):
                FgravX, FgravY += gravForce(p1, i, k)
    
        # Update the acceleration values
        ax1 = FgravX / p1[i].mass
        ay1 = FgravY / p1[i].mass
