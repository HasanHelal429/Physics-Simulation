...
class ExampleCharge(pc.Charge):

    def __init__(self, q=e, omega=2e15, amplitude=35e-9):
        super().__init__(q)
        self.omega = omega
...
pos = ax.scatter(charge.xpos(0), charge.zpos(0), s=5, c='red', marker='o')
...
def _update_animation(frame):
    ...
    Q.set_UVC(u/r, v/r)
    pos.set_offsets((charge.xpos(t), charge.zpos(t)))
    return im
...
n_frames = 288  # Number of frames in gif
...
plt.show()
#ani.save(filename="/Users/hasan/Python Animations/Test Anim.gif", writer="pillow",fps=50)